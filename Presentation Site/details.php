...
<?php
	...
	?>
            ...
            if ($flag == false)
                echo '<br>The selected zipcode does not exist in the database.';
            echo '<br /> <br /></div>';
    ...
    <div class="row">
        ...
        <div class="column" style="background-color:#6B8E23;">
            ...
            <ul>
              ...
              <div class="jumbotron text-center" style="background-color:#F0FFF0">
    <p>Enter a specific material</p> 
    <form action= "material.php" method="post">
      <div class="input-group">
        <input id="userInput" type="text" class="form-control" size="6" placeholder="Material Name" name="material" required>
